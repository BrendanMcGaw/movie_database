 ...
 */
export declare function instanceOfChangesResult(value: object): boolean;
export declare function ChangesResultFromJSON(json: any): ChangesResult;
export declare function ChangesResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangesResult;
